    ...
    <div class="container mx-auto my-20">
      ...
      @csrf
              <div class="grid xl:grid-cols-3 gap-4">
                ...
                <div>
                <input class="border-gray border shadow-lg rounded-lg p-3 md:w-80 w-60" name="postcodeFrom" type="text" placeholder="Collection Postcode">
                </div>
                <div>
                  <input class="border-gray border shadow-lg rounded-lg p-3 md:w-80 w-60" name="postcodeTo" type="text" placeholder="Delivery Postcode">
                </div>
                <div>
              ...
              <div id="pallet-options" class="bg-white w-100 z-index-10 mt-5 pb-5" hidden>
                <h1 class="antialiased text-3xl xl:text-left p-4 font-light">Pallet sizes</h1> 
                <div class="lg:flex justify-content-center rounded-lg gap-20 mx-auto">
                  ...
                  <div class="block form-group">
                  <label for="quater" class="block">Quater size</label> 
                  <button type="button" id="plus" class="h-10 bg-mobile-yellow cursor-pointer outline-none w-10 rounded-tl-lg rounded-bl-lg shadow-xs minus">-</button>
                    <input type="number" class="number-of-pallets h-10 outline-none focus:outline-none text-center bg-white font-semibold text-md" name="quater" value="0"></input>
                    <button type="button" id="minus" class="h-10 bg-mobile-yellow cursor-pointer outline-none w-10 rounded-tr-lg rounded-br-lg shadow-xs add">+</button>
                  </div>
                </div>
              </div>
