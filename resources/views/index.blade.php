        ...
        <h1 class=" text-3xl font-light p-4">Pallet Delivery</h1>
            <form class="text-center">
              <div class="grid xl:grid-cols-3 gap-4">
                ...
                <div>
                <input class="border-gray border shadow-lg rounded-lg p-3 md:w-80 w-60" name="postcode-from" type="text" placeholder="Collection Postcode">
                </div>
                <div>
                  <input class="border-gray border shadow-lg rounded-lg p-3 md:w-80 w-60" name="postcode-to" type="text" placeholder="Delivery Postcode">
                </div>
                <div>
...
<div class="fixed p-3 w-60 bg-blue h-60">
test
</div>
